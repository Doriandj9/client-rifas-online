            ...
            <div ref={refComponent}
             className="bg-primaryop-500 pt-[0.25rem] px-[0.15rem] w-72 rounded-lg shadow-md shadow-black relative">
                <button onClick={downloadImage}
                 title="Descargar Imagen" className="absolute py-3 px-5 top-1 right-0 bg-primary flex gap-2 text-white rounded-xl">
                   <FaCircleDown className="pointer-events-none w-7 h-7"/>
                </button>
