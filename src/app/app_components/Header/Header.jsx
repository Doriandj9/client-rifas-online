                ...
                <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                    <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            className="text-white bg-primary hover:bg-primaryop-900 focus:ring-4 focus:ring-primaryop-700 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-primary dark:hover:bg-primaryop-900 focus:outline-none dark:focus:ring-primaryop-700">
                                Inicio de Sesión
                            </NavLink>
                        ...
                        <div className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
                                    <NavLink  to={routesweb.inicio} className="block py-2 pl-3 pr-4 text-secondaryop-700 bg-primary rounded lg:bg-transparent lg:text-secondarylite lg:p-0 dark:text-white" aria-current="page">Inicio</NavLink>
                                </li>
                                <li>
                                    <NavLink to={routesweb.plans} className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-secondarylite lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Planes de compra</NavLink>
                                </li>
                                <li>
