import logo from './../../../assets/imgs/DigitalEducas-Logos/DigitalEducas_2023.png';
const Header  = () => {
    return (
        <>
                ...
                <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                    <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            <a href="#" className="text-white bg-secondarylite hover:bg-secondary focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-secondarylite focus:outline-none dark:focus:ring-secondary">Inicio de Sesión</a>
                        ...
                        <div className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
                                    <a href="#" className="block py-2 pl-3 pr-4 text-white bg-secondarylite rounded lg:bg-transparent lg:text-secondarylite lg:p-0 dark:text-white" aria-current="page">Inicio</a>
                                </li>
                                <li>
