...
const SidebarSeller = () => {
    ...
    const prefix = routesweb.dashboard.children.seller.root;
    ...
    return (
        <>
        {
            ...
            <p className="pl-4 text-md font-semibold text-white mb-1">Menú afiliados</p>
            <NavLink to={prefix + '/' + routes.solicitude.root} 
