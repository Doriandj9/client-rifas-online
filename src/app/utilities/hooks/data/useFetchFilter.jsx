 ...
 * @returns {*} { data, error, loading,total, refetch: fetchData, setData }
 */
const useFetchFilter = (url, options= {}, keyData= null, auth=false, apiKey='',dependencies=[], paginate=false, page=0) => {
    //hooks 
    ...
    return { data, error, loading,total, refetch: fetchData, setData }; 
}

export {useFetchFilter};