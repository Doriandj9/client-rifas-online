...
const FormRaffles = ({photo, handleChange}) => {
    return (
        <>
        <h3 className='text-center font-bold text-primary text-xl mt-6'>Proceso de verificación de usuarios organizadores de rifas.</h3>
        <p className='mb-8'>Para garantizar la autenticidad de todos nuestros vendedores y mantener un ambiente seguro para nuestros usuarios, requerimos un proceso de verificación adicional.</p>
        <List spacing={3}>
            <ListItem>
                <ListIcon as={MdCheckCircle} color='green.500' />
                Adjunta una imagen clara y legible de tu documento de identificación oficial. Esto nos ayudará a verificar tu identidad como vendedor.
            </ListItem>
            <ListItem>
                <ListIcon as={MdCheckCircle} color='green.500' />
