...
const routes = routesweb.dashboard.children.raffles.children.income.children;
...
const App = () => {
  ...
  useEffect(() => {
    if(handler.length === 3 && handler[2].handle['income.default']){
        navigate(routes.solicitude);
    }
  },[])
